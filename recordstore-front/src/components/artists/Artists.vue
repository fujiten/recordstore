<template>
  <div class="max-w-md m-auto py-10">
    ...
    <h3 class="font-mono font-regular text-3ml mb-4">Add a new art</h3>
    ...
    <form @submit.prevent="addArtist">
      ...
      <input type="submit" value="Add Artist" class="font-sans font-bold px-4 rounded cursor-pointer no-underlone bg-green hover:bg-green-dark block w-full py-4 text-white item-center justify-center"/>
    </form>
